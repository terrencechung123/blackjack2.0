...
Revision ID: 3a71bf6cdc1e
Revises: 
Create Date: 2023-04-16 13:03:02.275185
...
def upgrade():
    ...
    sa.Column('userHand', sa.String(), nullable=True),
    sa.Column('dealerHand', sa.String(), nullable=True),
