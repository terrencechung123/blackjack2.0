...
with app.app_context():
    ...
    cards = [
        ...
        Card(name='Ten of Hearts', value=10, suit='H', image = 'https://upload.wikimedia.org/wikipedia/commons/8/8a/10H.svg'),
        ...
        Card(name='Ten of Diamonds', value=10, suit='D', image = 'https://upload.wikimedia.org/wikipedia/commons/8/83/10D.svg'),
        ...
        Card(name='Ten of Clovers', value=10, suit='C', image = 'https://upload.wikimedia.org/wikipedia/commons/c/c7/10C.svg'),
        ...
        Card(name='Ten of Spades', value=10, suit='S', image = 'https://upload.wikimedia.org/wikipedia/commons/1/16/10S.svg'),
