...
with app.app_context():
    ...
    cards = [
        ...
        Card(name='Ten of Hearts', value=10, suit='H', image = 'https://deckofcardsapi.com/static/img/10H.png'),
        ...
        Card(name='Ten of Diamonds', value=10, suit='D', image = 'https://deckofcardsapi.com/static/img/10D.png'),
        ...
        Card(name='Ten of Clovers', value=10, suit='C', image = 'https://deckofcardsapi.com/static/img/10C.png'),
        ...
        Card(name='Ten of Spades', value=10, suit='S', image = 'https://deckofcardsapi.com/static/img/10S.png'),
